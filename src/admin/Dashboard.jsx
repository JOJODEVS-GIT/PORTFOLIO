...
const seedData = {
  ...
  projects: [
    ...
    { title: 'GestionPro — ERP Simplifié', description: "ERP web pour PME : produits, stock, achats, fournisseurs, production, ventes et clients, avec authentification par rôles (admin/employé) et tableaux de bord. 🔑 Démo : admin@gestionpro.com · mot de passe : admin123", gradient: 'from-[#1e3a5f] to-[#16C79A]', category: 'React', tech: ['Next.js', 'TypeScript', 'Prisma', 'PostgreSQL', 'Tailwind'], github: 'https://github.com/JOJODEVS-GIT/gestion-entreprise', live: 'https://gestion-entreprise-ten.vercel.app', imageUrl: '/images/gestion-pro.webp', order: 10 },
    { title: 'Wadagni 2026 — Site de campagne', description: "Site vitrine de campagne présidentielle (Bénin 2026) : hero animé, compteurs de statistiques, timeline du parcours, vision en 3 piliers et revue de presse.", gradient: 'from-[#0F3460] to-[#7a2e3a]', category: 'React', tech: ['Next.js', 'React', 'Tailwind'], github: 'https://github.com/JOJODEVS-GIT/wadagni-2026', live: 'https://wadagni-2026-beta.vercel.app', imageUrl: '/images/wadagni-2026.webp', order: 11 },
    { title: 'Akili — Boîte à outils d\'automatisation', description: "Application web qui automatise les tâches répétitives (factures, uploads, déploiements) en une commande. Projet du Hackathon EIG × Akili, Cotonou.", gradient: 'from-[#1b2430] to-[#f4a340]', category: 'React', tech: ['React', 'Vite', 'Tailwind'], github: 'https://github.com/JOJODEVS-GIT/akili-web', live: 'https://akili-web-eosin.vercel.app', imageUrl: '/images/akili.webp', order: 12 },
  ],
  skills: [
