...
const seedData = {
  ...
  projects: [
    ...
    { title: 'GestionPro — ERP Simplifié', description: "ERP web pour PME : produits, stock, achats, fournisseurs, production, ventes et clients, avec authentification par rôles (admin/employé) et tableaux de bord.", gradient: 'from-[#1e3a5f] to-[#16C79A]', category: 'React', tech: ['Next.js', 'TypeScript', 'Prisma', 'PostgreSQL', 'Tailwind'], github: 'https://github.com/JOJODEVS-GIT/gestion-entreprise', live: 'https://gestion-entreprise-ten.vercel.app', imageUrl: '/images/gestion-pro.webp', order: 10 },
