...
const seedData = {
  ...
  services: [
    ...
    { title: 'Applications mobiles', description: 'Des applications Android et iOS fluides et modernes (React Native, Flutter) — pour toucher vos clients directement sur leur téléphone.', iconName: 'Smartphone', features: ['Android & iOS', 'React Native / Flutter', 'Design mobile natif', 'Publication sur les stores'], order: 4 },
    { title: 'Intégration paiement Mobile Money', description: 'Encaissez en ligne avec Mobile Money (Kkiapay, Fedapay, MTN / Moov Money) et cartes — intégré proprement à votre site ou app.', iconName: 'Zap', features: ['MTN / Moov Money', 'Kkiapay, Fedapay', 'Paiement par carte', 'Transactions sécurisées'], order: 5 },
