...
const fallbackServices = [
  ...
  { iconName: 'Smartphone', title: 'Applications mobiles', description: 'Des applications Android et iOS fluides et modernes (React Native, Flutter) — pour toucher vos clients directement sur leur téléphone.', features: ['Android & iOS', 'React Native / Flutter', 'Design mobile natif', 'Publication sur les stores'] },
  { iconName: 'Zap', title: 'Intégration paiement Mobile Money', description: 'Encaissez en ligne avec Mobile Money (Kkiapay, Fedapay, MTN / Moov Money) et cartes — intégré proprement à votre site ou app.', features: ['MTN / Moov Money', 'Kkiapay, Fedapay', 'Paiement par carte', 'Transactions sécurisées'] },
